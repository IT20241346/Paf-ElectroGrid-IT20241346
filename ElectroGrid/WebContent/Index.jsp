...
<div>
<figure>
<a href="Employee.jsp"><img src="img/emp.png" class="rounded float-left m-5" alt="Employee" width="50%"></a>
...
<a href="Login.jsp" button type="button" class="btn btn-primary btn-lg"background-color:red">Logout</button></a>
