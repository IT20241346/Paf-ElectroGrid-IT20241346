      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-6">
            <h6>About</h6>
            <p class="text-justify">Dulmi Semini --- <i> </i> This project is based on a company named “ELECTROGRID". My task was to create the online platform covering for the Employee Management part. I used java , tomcat , mysql and JAX-RS Restful webservice as our tools to create our platform.</p>
          </div>
          ...
          <div class="col-xs-6 col-md-3">
            ...
            <ul class="footer-links">
              ...
              <li><a href="Customer.jsp">Employee Management</a></li>
